...
public class WeekStatisticsDemo extends JFrame {
	...
	public static WeekStatisticsFunc wfunc;
	
	private String statistics; // 통계내용

	public WeekStatisticsDemo(ArrayList<dayRecord> dR_ary) {
	...
	private class JComboEndtHandler implements ActionListener{
		public void actionPerformed(ActionEvent e) {
			...
			switch (WeekStatisticsFunc.chkDateSeq(startDate, endDate)) {
			case 0:
